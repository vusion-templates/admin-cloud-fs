...
<u-linear-layout direction="vertical">
    <u-form gap="large" @validate="valid = $event.valid">
        ...
        <u-form-item label="名称" required>
            <u-input disabled v-model="instance.Name" size="huge" maxlength="24" placeholder="1-24位小写字母、数字或中划线组成，以字母开头，字母或数字结尾"></u-input>
        </u-form-item>
...
export default {
    ...
    computed: {
        canSubmit() {
            return this.model.Description !== this.instance.Description;
        },
    },
    created() {
        this.getDetail().then(() => this.loadVpc());
    },
    methods: {
        loadVpc() {
        ...
        submit() {
            return ingressService.updateIngress(this.model)
